      ...
      <div className="contact__container container grid">
        <div className="contact__data">
          ...
          <div className="contact__socials">
            ...
            <a href="https://www.linkedin.com/in/kamaleesh-s/" className="contact__social-link"
              target='_blank'
            >
              <FaLinkedin />
            </a>
            <a href="https://github.com/Kamaleesh3" className="contact__social-link"
              target='_blank'
            >
              <FaGithub />
            </a>
